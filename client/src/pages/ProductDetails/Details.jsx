...
const Details = ({ isStitched, fabric, piece }) => {
  ...
  const handleSizeGuideOpen = () => {
    ...
    document
      ...
      .classList.add("sg-overflow-hidden");
  };
  ...
  const handleSizeGuideClose = () => {
    ...
    document
      .getElementById("product-container")
      .classList.remove("sg-overflow-hidden");
  };
  ...
  return (
    <>
      ...
      <div className="pd-info-details">
        <div>Quality guaranteed 100%</div>
        ...
        <>
          ...
          <div className="sg-popup-container">
            <div className="sg-popup-header">
              <div className="sg-popup-heading">Size Chart</div>
